...
export default function LoginPage() {
  ...
  const { login, autoLogin, checkMode, singleUserMode, modeChecked, manuallyLoggedOut, isLoading, error } = useAuthStore();
  ...
  useEffect(() => {
    ...
    if (singleUserMode && !manuallyLoggedOut) {
      autoLogin().then((success) => {
        if (success) router.push('/dashboard');
      });
    }
  }, [modeChecked, singleUserMode, manuallyLoggedOut, autoLogin, checkMode, router]);
