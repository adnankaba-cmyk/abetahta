...
-- Tarih: 2026-02-22
-- NOT: Bu dosya docs/database-schema.sql ile senkronize tutulmalıdır.
--       Docker init o dosyayı kullanır, bu dosya referans/dokümantasyondur.
...
DO $$ BEGIN
  CREATE TRIGGER trg_elements_updated BEFORE UPDATE ON elements FOR EACH ROW EXECUTE FUNCTION update_updated_at();
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
